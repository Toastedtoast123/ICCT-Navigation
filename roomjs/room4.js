...
document.getElementById('viewer4').appendChild(renderer.domElement);
...
const graph = {
    ...
    'Hallway3': ['Hallway3a', 'Hallway3b', 'Elevator', 'B4-41', 'B4-44'],
    'Hallway3a': ['Hallway3', 'Hallway3b', 'Elevator', 'B4-42', 'B4-45'],
    'Hallway3b': ['Hallway3', 'Hallway3a', 'Elevator', 'B4-46', 'B4-43'],
    ...
    'Hallway6a': ['Hallway6', 'Hallway6b', 'Hallway6c', 'B2-41', 'B2-44'],
    'Hallway6b': ['Hallway6', 'Hallway6a', 'Hallway6c', 'B2-42', 'B2-45'],
    'Hallway6c': ['Hallway6', 'Hallway6a', 'Hallway6b', 'Hallway8', 'B2-43', 'B2-46'],
    ...
    'Hallway9': ['Canteen', 'Hallway7', 'Hallway8' , 'Hallway5', 'Hallway4', 'Hallway2a' ],
    'Canteen': ['Hallway9'],
    'B2.up': ['Hallway7a' ],
    'B2.down': ['Hallway5a'],
    'B4.up': ['Hallway2'],
...
const connectionPoints = {
    'Hallway1': { x: -140, y: 0, z: 58 },
    'Hallway1a': { x: -140, y: 0, z: 73 },
    'Hallway2': { x: -50, y: 0, z: 58},
    'Hallway2a': { x: -50, y: 0, z: 73 },
    'Hallway3': { x: -100, y: 0, z: 6 },
    'Hallway3a': { x: -100, y: 0, z: -42 },
    'Hallway3b': { x: -100, y: 0, z: -58 },
    'Hallway4': { x: -0, y: 0, z: 73 },
    'Hallway5': { x: 50, y: 0, z: 73 },
    'Hallway5a': { x: 50, y: 0, z: 58 },
    'Hallway6': { x: 100, y: 0, z: 58 },
    'Hallway6a': { x: 100, y: 0, z: 6 },
    'Hallway6b': { x: 100, y: 0, z: -42 },
    'Hallway6c': { x: 100, y: 0, z: -58 },
    'Hallway7': { x: 140, y: 0, z: 73 },
    'Hallway7a': { x: 140, y: 0, z: 58 },
    'Hallway8': { x: 100, y: 0, z: 73 },
    'Hallway9': { x: -75, y: 0, z: 73 },
    'Canteen': { x: -75, y: 0, z: 83 },
    'B2.up': { x: 155, y: 0, z: 58 },
    'B2.down': { x: 30, y: 0, z: 58 },
    'B4.up': { x: -30, y: 0, z: 58 },
    'B4.down': { x: -155, y: 0, z: 58 },
    'Elevator': { x: -100, y: 0, z: 58 },
    'B4-41': { x: -112, y: 0, z: 6 },
    'B4-42': { x: -112, y: 0, z: -42 },
    'B4-43': { x: -112, y: 0, z: -58 },
    'B4-44': { x: -88, y: 0, z: 6 },
    'B4-45': { x: -88, y: 0, z: -42 },
    'B4-46': { x: -88, y: 0, z: -58 },
    'B2-41': { x: 88, y: 0, z: 6 },
    ...
    'B2-43': { x: 88, y: 0, z: -58 },
    'B2-44': { x: 112, y: 0, z: 6 },
    'B2-45': { x: 112, y: 0, z: -42 },
    'B2-46': { x: 112, y: 0, z: -58 },
    'CR.B': { x: 0, y: 0, z: 65 },
    'CR.G1': { x: 157, y: 0, z: 73 },
    'CR.G2': { x: -157, y: 0, z: 73 },
};
