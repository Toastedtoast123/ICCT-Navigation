...
document.getElementById('viewer5').appendChild(renderer.domElement);
...
const graph = {
    ...
    'Hallway3': ['Hallway3a', 'Hallway3b', 'Elevator', 'B4-54', 'B4-51'],
    'Hallway3a': ['Hallway3', 'Hallway3b', 'Elevator', 'B4-52', 'B4-55'],
    'Hallway3b': ['Hallway3', 'Hallway3a', 'Elevator', 'B4-56', 'B4-53'],
    ...
    'Hallway6a': ['Hallway6', 'Hallway6b', 'Hallway6c', 'B2-51', 'B2-54'],
    'Hallway6b': ['Hallway6', 'Hallway6a', 'Hallway6c', 'B2-52', 'B2-55'],
    'Hallway6c': ['Hallway6', 'Hallway6a', 'Hallway6b', 'B2-53', 'B2-56'],
...
const connectionPoints = {
    'Hallway1': { x: -140, y: 0, z: 69 },
    'Hallway1a': { x: -140, y: 0, z: 85 },
    'Hallway2': { x: -50, y: 0, z: 69 },
    'Hallway2a': { x: -50, y: 0, z: 85 },
    'Hallway3': { x: -100, y: 0, z: 20 },
    'Hallway3a': { x: -100, y: 0, z: -30 },
    ...
    'Hallway7': { x: 140, y: 0, z: 85 },
    'Hallway7a': { x: 140, y: 0, z: 69 },
    'Hallway8': { x: 100, y: 0, z: 85 },
    'B2.up': { x: 155, y: 0, z: 69 },
    'B2.down': { x: 30, y: 0, z: 69 },
    'B4.up': { x: -30, y: 0, z: 69 },
    'B4.down': { x: -155, y: 0, z: 69 },
    'Elevator': { x: -100, y: 0, z: 69 },
    'B4-51': { x: -112, y: 0, z: 20 },
    'B4-52': { x: -112, y: 0, z: -30 },
    'B4-53': { x: -112, y: 0, z: -50 },
    'B4-54': { x: -88, y: 0, z: 20 },
    'B4-55': { x: -88, y: 0, z: -30 },
    'B4-56': { x: -88, y: 0, z: -50 },
    'B2-51': { x: 88, y: 0, z: 20 },
    'B2-52': { x: 88, y: 0, z: -30 },
    'B2-53': { x: 88, y: 0, z: -50 },
    'B2-54': { x: 112, y: 0, z: 20 },
    'B2-55': { x: 112, y: 0, z: -30 },
    'B2-56': { x: 112, y: 0, z: -50 },
    'CR.B': { x: 0, y: 0, z: 74 },
    'CR.G1': { x: 157, y: 0, z: 85 },
    'CR.G2': { x: -157, y: 0, z: 85 },
};
